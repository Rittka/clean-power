...
<div class="container">
    ...
    <div class="card card-custom">
        ...
        <h1 style="font-size : 3rem">تقرير الموظفين العام</h1>
        </div>
        <div class="card-body">
            <div class="mb-7">
...
@section('js')
    <script>
         ...
         var datatable = $('#kt_datatable').KTDatatable({
            ...
            // columns definition
            columns: [ {
                field: 'first_name', title: 'الاسم ',
            }, {
                field: 'last_name', title: 'الكنية',
            ...
            {
                field: 'age', title: ' العمر ',
            },
            {
                field: 'gender', title: ' الجنس ',
            },
            {
                field: 'metarial', title: ' الحالة الاجتماعية ',
            },
            {
                field: 'totsalaryal', title: ' الراتب  ',
            },
            ],
