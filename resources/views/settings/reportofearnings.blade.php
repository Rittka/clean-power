...
@section('title', 'تقرير هامش الربح ')
...
<div class="container">
    ...
    <div class="card card-custom">
        ...
        <h1 style="font-size : 3rem">تقرير هامش الربح الشهري</h1>
        </div>
        <div class="card-body">
            <div class="mb-7">
...
@section('js')
    <script>
         ...
         var datatable = $('#kt_datatable').KTDatatable({
            ...
            // columns definition
            columns: [ {
                field: 'total_salary', title: 'إجمالي رواتب الموظفين  ',
            }, {
                field: 'total_cost', title: 'إجمالي تكاليف المعدات ',

            },{
                field: 'total_sales', title: 'إجمالي مبيعات  ',
            },{
                field: 'total_earning', title: '  هامش الربح',
            },
