    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="topbar">
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                    <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
                        @if(LaravelLocalization::getCurrentLocale()=='ar')
                            <img class="h-20px w-20px rounded-sm" src="{{asset('assets/media/svg/flags/022-syria.svg')}}" alt="{{LaravelLocalization::getCurrentLocale().' flag'}}" />
                        @else
                            <img class="h-20px w-20px rounded-sm" src="{{asset('assets/media/svg/flags/012-uk.svg')}}" alt="{{LaravelLocalization::getCurrentLocale().' flag'}}" />
                        @endif
                    </div>
                </div>
                <!--end::Toggle-->
                            ...
                            <li class="navi-item">
                                <a hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}" class="navi-link">
                                    <span class="symbol symbol-20 mr-3">
                                        @if($localeCode=='ar')
                                            <img class="h-20px w-20px rounded-sm" src="{{asset('assets/media/svg/flags/022-syria.svg')}}" alt="{{$localeCode.' flag'}}" />
                                        @else
                                            <img class="h-20px w-20px rounded-sm" src="{{asset('assets/media/svg/flags/012-uk.svg')}}" alt="{{$localeCode.' flag'}}" />
                                        @endif
                                    </span>
                                    <span class="navi-text">{{trans('main.'.$localeCode.'_name')}}</span>
                                </a>
                            </li>
                        @endforeach
                    </ul>
            ...
            <div class="topbar-item">
                <div id="logoutBtn"  class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
