            ...
            <ul class="menu-nav">
                ...
                <li class="menu-item menu-item-submenu @if (strpos($current_params, 'SettingController')) menu-item-active menu-item-open @endif" aria-haspopup="true"
                    ...
                    <div class="menu-submenu">
                        <i class="menu-arrow"></i>
                        <ul class="menu-subnav">
                            <li class="menu-item @if (strpos($current_params, 'SettingController@showUsers')) menu-item-active @endif" aria-haspopup="true">
                                <a href="{{ url('user') }}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">جميع حسابات المستخدمين</span>
                                </a>
                            </li>
                            <li class="menu-item @if (strpos($current_params, 'SettingController@createNewUser')) menu-item-active @endif" aria-haspopup="true">
                                <a href="{{ url('user/create') }}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">إضافة حساب جديد</span>
                                </a>
                            </li>
                        </ul>
                    </div>
