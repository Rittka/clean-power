    ...
    <div class="container">
        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap border-0 pt-6 pb-0">
                ...
                <h1 style="font-size : 3rem">الصيانات</h1>
                </div>
         ...
         var datatable = $('#kt_datatable').KTDatatable({
...

            {
                ...
                template: function(data) {
                    return '\
                    <a href="{{ url('maintenance')}}/'+data.id+'/show" class="btn btn-sm btn-clean btn-icon mr-2" title="تفاصيل">\
                        <i class="far fa-eye text-primary"></i>\
                  </a>\
                        <a href="{{url('maintenance')}}/'+data.id+'/edit" class="btn btn-sm btn-clean btn-icon " title="تعديل">\
