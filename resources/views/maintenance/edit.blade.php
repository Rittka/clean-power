                            ...
                            <div class="wizard-step" data-wizard-type="step" data-wizard-state="current">
                                <div class="wizard-wrapper">
                                    ...
                                    <div class="wizard-label">
                                        ...
                                        <div class="wizard-desc">بيانات الصيانة</div>
                                    </div>
                                </div>
                            </div>
                            <div class="wizard-step" data-wizard-type="step">
                                <div class="wizard-wrapper">
                                    ...
                                    <div class="wizard-label">
                                        ...
                                        <div class="wizard-desc"> المعدات المعطلة</div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-xl-12">
                                                ...
                                                <div class="my-5 step" data-wizard-type="step-content"
                                                    ...
                                                    <h5 class="text-dark font-weight-bold mb-10">تعديل بيانات الصيانة</h5>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-form-label col-3 text-lg-right text-left">رمز
                                                            المشروع</label>
                                                        <div class="col-9">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-form-label col-3 text-lg-right text-left">موظف
                                                            الصيانة</label>
                                                        <div class="col-9">
                                                        ...
                                                        <div class="col-9">
                                                            <div
                                                                ...
                                                                <div class="input-group-prepend">
                                                                    <span class="input-group-text">
                                                                        <i
                                                                            class="fas fa-edit text-primary icon-lg"></i>
                                                                    </span>
                                                                </div>
                                                                <input id="input2"
                                                                    class="form-control form-control-solid form-control-lg"
                                                ...
                                                <!--begin::Wizard Step 2-->
                                                <div class="my-5 step" data-wizard-type="step-content">
                                                    <h5 class="text-dark font-weight-bold mb-10 mt-5">تعديل المعدات المعطلة</h5>
