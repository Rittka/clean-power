                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9 ">
                                <div class="input-group input-group-lg input-group-solid border border-primary">
                                    ...
                                    <input type="email" name="email" class="form-control form-control-lg form-control-solid " value="email"  />
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-9 ">
                                <div class="input-group input-group-lg input-group-solid border border-primary">
                                    ...
                                    <input type="password" name="password" class="form-control form-control-lg form-control-solid " value="password"  />
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <div class="input-group input-group-solid input-group-lg border border-primary">
                                    ...
                                    <select class="form-control" name="role_id" id="selecr_role">
