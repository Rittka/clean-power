<div id="StudentMarksModal" class="modal " role="dialog" >
    <div class="modal-dialog modal-xl">
        <div class="modal-content" >
            <div class="modal-header py-5">
                <h5 class="modal-title">علامات الطالب
            ...
            <div class="modal-body">
                                ...
                                <div class="col-md-4 my-2 my-md-0">
                                    <div class="input-icon">
                                        <input type="text" class="form-control" placeholder={{ trans('main.search') }}
                                            id="kt_datatable_student_marks_search_query" />
                                        <span>
                ...
                <!--end: Search Form-->
                <!--begin: Datatable-->
                <div class="datatable datatable-bordered datatable-head-custom" id="kt_datatable_student_marks"></div>
                <!--end: Datatable-->
            </div>
        </div>
    </div>
