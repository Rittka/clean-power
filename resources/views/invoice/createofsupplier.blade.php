    ...
    <div class="container">
        ...
        <div class="card card-custom">
            <div class="card-header">
                <h3 class="card-title">أضف فاتورة مورد جديدة</h3>
            ...
            <form class="box" method="post" action="/staff">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-xl-3 col-lg-3 col-form-label text-right">اسم المورد</label>
                        <div class="col-lg-9 col-xl-6">

                            <input type="text" class="form-control form-control-lg form-control-solid border border-primary"
                                name="supplier_name" value="{{ old('full_name') }}" placeholder="الاسم " required />
                        </div>
                    </div>
                    <div class="form-group row">
